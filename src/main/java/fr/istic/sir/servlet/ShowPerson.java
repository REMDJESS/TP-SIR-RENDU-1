...
public class ShowPerson extends HttpServlet{
	...
	public void doGet(HttpServletRequest req, HttpServletResponse resp)
		...
		for(Person next : personsResult) {
			...
			out.println("Nom : " + next.getFirstName()+"<br />");
			out.println("Prenom: " + next.getLastName()+"<br /><br />");
			out.println("Email : " + next.getEmail()+"<br /><br />");
			out.println("Facebook : " + next.getFacebook()+"<br /><br />");
			out.println("Sexe : " + next.getSex()+"<br /><br />");
			out.println("Anniversiare : " + next.getBirthday()+"<br /><br />");
		}
		out.println("</body>\n</html>");
	}
}
